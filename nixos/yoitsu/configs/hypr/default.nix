...
exec = ${pkgs.clipse}/bin/clipse -kill ;sleep 1; ${pkgs.clipse}/bin/clipse -listen
...
# vim: filetype=hyprlang
# Workspace Binding.
workspace = 1,monitor:DP-3,rounding:true,decorate:true,gapsin:5,gapsout:15
workspace = 2,monitor:DP-3,rounding:true,decorate:true,gapsin:5,gapsout:15
workspace = 3,monitor:DP-3,rounding:true,decorate:true,gapsin:5,gapsout:15
workspace = 4,monitor:DP-3,rounding:true,decorate:true,gapsin:5,gapsout:15
workspace = 5,monitor:DP-3,rounding:true,decorate:true,gapsin:5,gapsout:15
