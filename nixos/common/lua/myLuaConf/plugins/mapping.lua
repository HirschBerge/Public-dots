...
vim.keymap.set("n", "<leader>pf", "<cmd> Telescope find_files <CR>", {desc = "Telescope Files"} )
vim.keymap.set("n", "<C-p>", "<cmd> Telescope git_files  <CR>", {desc = "Telescope Grep"})
...
vim.api.nvim_set_keymap('n', '<leader>rcu', ':lua require("crates").upgrade_all_crates()<CR>', { noremap = true, silent = true, desc = "Upgrade Crates."})

vim.api.nvim_set_keymap('n', '<leader>/', ':lua require("Comment.api").toggle.linewise.current()<CR>', { noremap = true, silent = true, desc = "Upgrade Crates."})
vim.api.nvim_set_keymap('v', '<leader>/', ':lua require("Comment.api").toggle.linewise.current()<CR>', { noremap = true, silent = true, desc = "Upgrade Crates."})
